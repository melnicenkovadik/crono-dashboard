...
export const kpiMetrics: KpiMetric[] = [
  ...
  { id: 'companies', label: 'Companies engaged', value: 264, target: 500, format: 'count' },
  { id: 'activities', label: 'Activities', value: 1000, target: 2000, format: 'count' },
  { id: 'meetings', label: 'Meetings', value: 20, target: 30, format: 'count' },
  { id: 'deals', label: 'Deals', value: 100, target: 200, format: 'count' },
  { id: 'pipeline', label: 'Pipeline', value: 50_000, target: 100_000, format: 'euro-k' },
]
